// File: BoxUtilities.gs
// Box-specific utilities following Bruce McPherson's patterns and principles
// Uses cUseful library by Bruce McPherson
// Contains utilities that could potentially contribute back to Bruce's ecosystem

/**
 * Box-specific utilities following Bruce McPherson's organizational patterns.
...
var BoxUtils = (function() {
  ...
  /**
   * Math utilities that could extend cUseful.
   */
...
function getLibraryInfo() {
  return {
    info: {
      name: 'BoxUtilities',
      version: '1.0.0',
      description: 'Box-specific utilities following Bruce McPherson patterns',
